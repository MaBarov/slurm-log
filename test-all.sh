...
for test_script in package_smoke offline_hostile pane_close interactive_pane \
    details_pane focus_toast cli_surface picker_controls daemon_integration \
    workspace_controls feature_coverage bank_actions bank_ui cluster_tabs \
    smart_close setup_wizard source_layout; do
